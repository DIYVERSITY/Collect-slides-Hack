...
const url = "https://api.unsplash.com/search/photos?client_id=BJfIu7ylioVKHF-tFoZ08EU7kIgTmkVZ3_u34n5UQA8&page=1&query="
class ImageArea extends Component {
    ...
    getImages = ()=>{
        ...
        axios.get(url+this.props.keyword)
        .then((response)=>{
              ...
              <GridList className={classes.gridList} cols={2.5}>
                {this.state.tileData.map((tile, index) => (
                  <GridListTile key={tile.urls.regular}>
                    <img src={tile.urls.regular} alt={tile.description} onClick={this.handleClick} name={index}/>
                    <GridListTileBar
